...
const products = ["Monitor", "Mouse", "Teclado", "Cadeira", "Mesa", "Mousepad", "Microfone", "Headset", "Celular"];

function ProductCard({ name, addToCart }) {
  return (
    <div className="col-md-4">
      <Card>
        <Card.Img variant="top" src={`./src/assets/${name.toLowerCase()}.webp`} />
        <Card.Body>
      ...
      <Container className="mt-5">
        ...
        <div className="row">
          {products.map((product, i) => (
            <ProductCard name={product} key={i} addToCart={addToCart} />
          ))}
        </div>
      </Container>
