...
-- Relatório de clientes com telefone
create view vw_cliente as
select c.*, t.numero as telefone from Cliente c
left join Telefone t on c.cpf = t.cpf;

-- Crie um relatorio semelhante ao anterior porém acrescido de uma coluna status que informa se o aluguel está concluído, em andamento ou reservado e salve com o nome vw_todos_os_alugueis
...
select * from vw_todos_os_alugueis where status = 'Reservado';
...
select * from vw_todos_os_alugueis where status = 'Em andamento';
